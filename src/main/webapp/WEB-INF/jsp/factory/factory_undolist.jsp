...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 加工订单<span class="c-gray en">&gt;</span> 未完成订单管理
    <a
...
<div class="pd-20">
    ...
    <span class="l">
    <a href="order?_type=factorylistdone" class="btn btn-primary radius"><i
            class="icon-plus"></i> 已完成订单列表</a></span>
            ...
            <tr class="text-c">
                ...
                <td><span class="l" style="display: flex; justify-content: center;">
                    <form style="margin-right: 10px; display: inline-block;"
                          action="<c:url value="/order?_type=toComplete"/>" method="post">
                        <input type="hidden" id="editid" name="completeid" value="${order.order_id}">
               <input type="submit" value="完成订单" class="btn btn-primary radius">
                        </form>
                </span></td>
            </tr>
        </c:forEach>
